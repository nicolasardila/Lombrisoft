  ...
  <div class="card-body">
   <center>
    <div class="card" style="width: 80rem">
        <h5 class="card-header">Lista de Herramientas Rentables</h5>
        <div class="card-body">
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="table table-responsive">
            <table class="table table-bordered table-striped">
                <thead>
                    ...
                    <th>Marca</th>
                    <th>Tipo</th>
                    <th>Valor Unidad Herramienta</th>
                    <th>Cantidad</th>
                    <th>Proveedor</th>
                    <th>Estado</th>
                ...
                @foreach ($datos as $item)
                    <tr>
                        ...
                        data-nombre_her="{{ $item->nombre_her}}"
        ...
        <div class="modal-content">
            ...
            @method('PUT')
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="edit-nombre_her" class="form-label">Nombre Herramienta</label>
                        <input type="text" class="form-control" id="edit-nombre_her" name="nombre_her">
                    </div>
                    <div class="mb-3">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.querySelectorAll('.editbtn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('edit-nombre_her').value = this.getAttribute('data-nombre_her');
